...
const Post = () => {
  return (
    <div className="mt-10 bg-neutral-100 w-[800px] h-72 p-8 shadow-xl rounded-lg ">
      <div className="flex">
        <Avatar sx={{ width: 54, height: 54 }} alt="Remy Sharp" src={av} />
      ...
      <div className="justify-between flex mt-8 items-center ">
        <div className="">
